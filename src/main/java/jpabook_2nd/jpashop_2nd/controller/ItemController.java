...
public class ItemController {
    ...
    public String updateItemForm(@PathVariable("itemId") Long itemId, Model model) {
        Book updateBook = (Book) itemService.find(itemId);

        BookForm form = new BookForm();
        form.setId(updateBook.getId());
        form.setName(updateBook.getName());
        form.setPrice(updateBook.getPrice());
        form.setStockQuantity(updateBook.getStockQuantity());
        form.setAuthor(updateBook.getAuthor());
        form.setIsbn(updateBook.getIsbn());
